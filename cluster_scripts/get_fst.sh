...
echo "getting dxy"
getDxy.pl --pop1maf <(zcat mafs/$pop1.mafs.gz ) --pop2maf <(zcat mafs/$pop2.mafs.gz ) --minInd 1 | awk 'NR > 1{print $1,$2-1,$2,$3}' OFS="\t" | bedtools sort -i - > $pop1$pop2.snp.dxy
bedtools map -nonamecheck -a ref/ahy_10kb_intervals.bed -b $pop1$pop2.snp.dxy -c 4 -o sum > processed_data/$pop1.$pop2.dxy
