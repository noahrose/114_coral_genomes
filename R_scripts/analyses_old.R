...
PBS$HE<-(getPBSwin(HA.HE, HD.HE, HA.HD,edges=edges)+getPBSwin(HA.HE, HC.HE, HA.HC,edges=edges)+getPBSwin(HC.HE, HD.HE, HC.HD,edges=edges))/3
...
snsTest<-sns[sns$warn=='WARNING_REF_DOES_NOT_MATCH_GENOME',]
fisher.test(snsTest $HA> quantile(snsTest $HA,0.95), snsTest$missense)
fisher.test(snsTest $HC> quantile(snsTest $HC,0.95), snsTest$missense)
fisher.test(snsTest $HD> quantile(snsTest $HD,0.95), snsTest$missense)
fisher.test(snsTest $HE> quantile(snsTest $HE,0.95), snsTest$missense)
snsTest<-sns[(sns$warn=='OK'|sns$warn=='WARNING_REF_DOES_NOT_MATCH_GENOME'),]
HA<-fisher.test(snsTest $HA> quantile(snsTest $HA,0.99), snsTest$missense)
HC<-fisher.test(snsTest $HC> quantile(snsTest $HC,0.99), snsTest$missense)
HD<-fisher.test(snsTest $HD> quantile(snsTest $HD,0.99), snsTest$missense)
HE<-fisher.test(snsTest $HE> quantile(snsTest $HE,0.99), snsTest$missense)
...
layout(rbind(c(1,1,1,1),c(2,3,4,5),c(6,7,8,9)))
par(mar=c(3,3,2,1),mgp=c(1.7,0.1,0),las=1,tck=0.01,cex.axis=1,lwd=1,cex=0.5,bty='l',cex.main=1.5)
snsPlot<-sns[sns$HE>0.1&sns$missense,]
plot(snsPlot$HE,cex=0.2)
points(which(snsPlot$HA.HE>0.99&snsPlot$HC.HE>0.99&snsPlot$HD.HE>0.99&snsPlot$missense),snsPlot$HE[which(snsPlot$HA.HE>0.99&snsPlot$HC.HE>0.99&snsPlot$HD.HE>0.99&snsPlot$missense)],col='red',cex=0.5)
points(which(snsPlot$HE>5&snsPlot$missense),snsPlot$HE[which(snsPlot$HE>5&snsPlot$missense)],col='red')
Amillepora15251<-read.tree('proteins/Amillepora15251.new')
plot(Amillepora15251,x.lim=c(0.15))
Amillepora12599<-read.tree('proteins/Amillepora12599.new')
plot(Amillepora12599,x.lim=c(0.15))
Amillepora12602<-read.tree('proteins/Amillepora12602.new')
plot(Amillepora12602,x.lim=c(0.15))
Amillepora00680<-read.tree('proteins/Amillepora00680.new')
plot(Amillepora00680,x.lim=c(0.15))
Amillepora10166<-read.tree('proteins/Amillepora10166.new')
plot(Amillepora10166,x.lim=c(0.15))
