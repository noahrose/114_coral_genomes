...
png('../Figures/FigureS7.png',width=8,height=6,res=300,units='in')
...
png('../Figures/Figure2.png',width=6,height=6,res=300,units='in')
par(mar=c(3,3,2,1),mgp=c(1.7,0.1,0),las=1,tck=0.01,cex.axis=1,lwd=1,bty='l')
layout((rbind(c(1,1),c(2,3))),heights=1)
...
png('../Figures/FigureS8.png',width=8,height=4,res=300,units='in')
par(mar=c(3,3,2,1),mgp=c(1.7,0.1,0),las=1,tck=0.01,cex.axis=1,lwd=1,bty='l',mfrow=c(1,2))
...
png('../Figures/Figure3.png',width=5,height=6,res=300,units='in')
